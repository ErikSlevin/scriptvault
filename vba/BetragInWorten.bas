...
' Globale Variablen f�r Zahlworte und Hilfsworte in Deutsch
Private Zahlworte(0 To 28) As String
Private Hilfsworte(1 To 4) As String

' Diese Funktion wandelt eine Zahl in Worten um und gibt das Ergebnis zur�ck.
Function InWorten(ByVal Zahl As String) As String
    ' Aufruf der Funktion zur Umwandlung von Zahlen in W�rter mit deutscher Sprache
...
Dim Dezimalstelle As Integer, Z�hler As Integer
Dim Stelle(1 To 6) As String
Dim dZahl As Double
Dim Pr�fix As String, Suffix As String

' Definition der Platzhalter f�r die Zahlenskalen
Stelle(1) = ""
Stelle(2) = " Tausend "
Stelle(3) = " Millionen "
Stelle(4) = " Milliarden "
Stelle(5) = " Billionen "
Stelle(6) = " Die Mantisse ist nicht gro� genug f�r diese Zahl "
...
' �berpr�fen, ob die Zahl innerhalb des unterst�tzten Bereichs liegt
...
Do While Zahl <> ""
    ...
    If Temp <> "" Then
        If Euro <> "" Then
            Euro = Temp & Stelle(Z�hler) & " " & _
                   Hilfsworte(4) & " " & Euro
        Else
            Euro = Temp & Stelle(Z�hler) & Euro
        End If
    End If
    If Len(Zahl) > 3 Then
...
' Ergebnis zusammenf�hren und formatieren
...
' Gesamtergebnis zur�ckgeben
ZahlInWorten = Pr�fix & Temp & Suffix

End Function

' Diese Funktion wandelt eine dreistellige Zahl in Worten um und gibt das Ergebnis zur�ck.
...
' Diese Funktion wandelt eine zweistellige Zahl in Worten um und gibt das Ergebnis zur�ck.
...
' Diese Funktion wandelt eine einzelne Ziffer in Worten um und gibt das Ergebnis zur�ck.
